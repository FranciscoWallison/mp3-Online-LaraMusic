...
<head>
	...
	<!--Favicon-->
	<link rel="ico" type="imge/png" href="./imgs/favicon-laramusic.png">

	<!--Inicio do jPlayer CSS-->
...
<div class="container">
	...
	<footer class="footer">
		<div class="conteiner text-center">
			...
			<p class="text-footer">CopyRight Francisco Wallison - Todos os direitos <?=date('Y')?> <br> franciscoWallison@gmail.com</p>
		</div><!--End conteiner-->
	</footer><!--End Footer-->
