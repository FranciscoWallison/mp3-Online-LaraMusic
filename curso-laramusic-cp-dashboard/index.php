		...
		<form class="col-md-12 login" action="painel.php" method="post">
			<div class="row">
				<div class="input-field col s12">
					...
					<label for="email" data-error="E-mail Invalido" data-success="E-mail Valido">Email</label>
				</div>
				<div class="input-field col s12">
					<input id="password" type="password" class="validate">
					<label for="password" data-error="Senha" data-success="Prenchido">Senha</label>
				</div>
				<div class="input-field col s12">
					<input class="waves-effect waves-light btn btn-login" type="submit" name="enviar" value="Entrar">
				</div>
				<div class="input-field col s12 recuperar-senha">
					<a href="recuperar.php" class="recuperar-senha">
						Recuperar Senha?
					</a>
				</div>
			</div>
