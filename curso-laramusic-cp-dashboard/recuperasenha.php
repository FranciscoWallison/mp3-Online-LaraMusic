		...
		<form class="col-md-12 login" action="painel.php" method="post">
			<div class="row">
				<div class="input-field col s12">
					...
					<label for="password" data-error="Senha" data-success="Prenchido">Nova Senha</label>
				</div>
				<div class="input-field col s12">
					<input id="password" type="password" class="validate">
					<label for="password" data-error="Senha" data-success="Prenchido">Repetir Senha</label>
				</div>
				<div class="input-field col s12">
